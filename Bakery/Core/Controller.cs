...
namespace Bakery.Core
{
    ...
    {
        private List<IBakedFoods> bakedFoods;
        ...
        public Controller()
        {
            bakedFoods = new List<IBakedFoods>();
        ...
        public string GetFreeTablesInfo()
        {
            ...
            foreach (var freeTabe in freeTables)
            {
                result += freeTabe.GetFreeTableInfo() + Environment.NewLine;
            }
        ...
        public string OrderFood(int tableNumber, string foodName)
        {
            ...
            {
                IBakedFood food = (IBakedFood)bakedFoods.FirstOrDefault(f => f.Name == foodName);
                if(food == null)
                {
